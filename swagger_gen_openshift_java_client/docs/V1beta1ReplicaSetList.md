...
**items** | [**List&lt;V1beta1ReplicaSet&gt;**](V1beta1ReplicaSet.md) | List of ReplicaSets. More info: http://releases.k8s.io/release-1.4/docs/user-guide/replication-controller.md | 
