...
**items** | [**List&lt;V1ServiceAccount&gt;**](V1ServiceAccount.md) | List of ServiceAccounts. More info: http://releases.k8s.io/release-1.4/docs/design/service_accounts.md#service-accounts | 
