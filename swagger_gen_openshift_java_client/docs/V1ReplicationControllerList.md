...
**items** | [**List&lt;V1ReplicationController&gt;**](V1ReplicationController.md) | List of replication controllers. More info: http://releases.k8s.io/release-1.4/docs/user-guide/replication-controller.md | 
