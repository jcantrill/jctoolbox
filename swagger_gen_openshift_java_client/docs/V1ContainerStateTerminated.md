...
**finishedAt** | **String** | Time at which the container last terminated |  [optional]
...
**startedAt** | **String** | Time at which previous execution of the container started |  [optional]
