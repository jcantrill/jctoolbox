...
import com.openshift.restclient.model.V1alpha1CertificateSigningRequestCondition;
...
public class V1alpha1CertificateSigningRequestStatus   {
  ...
  public V1alpha1CertificateSigningRequestStatus certificate(String certificate) {
