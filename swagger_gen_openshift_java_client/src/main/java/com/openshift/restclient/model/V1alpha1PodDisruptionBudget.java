...
import com.openshift.restclient.model.V1alpha1PodDisruptionBudgetSpec;
import com.openshift.restclient.model.V1alpha1PodDisruptionBudgetStatus;
...
public class V1alpha1PodDisruptionBudget   {
  ...
  @SerializedName("spec")
  private V1alpha1PodDisruptionBudgetSpec spec = null;

  @SerializedName("status")
  private V1alpha1PodDisruptionBudgetStatus status = null;

  public V1alpha1PodDisruptionBudget apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PodDisruptionBudget kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1alpha1PodDisruptionBudget metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1alpha1PodDisruptionBudget spec(V1alpha1PodDisruptionBudgetSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1alpha1PodDisruptionBudgetSpec getSpec() {
    return spec;
  }

  public void setSpec(V1alpha1PodDisruptionBudgetSpec spec) {
    this.spec = spec;
  }

  public V1alpha1PodDisruptionBudget status(V1alpha1PodDisruptionBudgetStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1alpha1PodDisruptionBudgetStatus getStatus() {
    return status;
  }

  public void setStatus(V1alpha1PodDisruptionBudgetStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1PodDisruptionBudget v1alpha1PodDisruptionBudget = (V1alpha1PodDisruptionBudget) o;
    return Objects.equals(this.apiVersion, v1alpha1PodDisruptionBudget.apiVersion) &&
        Objects.equals(this.kind, v1alpha1PodDisruptionBudget.kind) &&
        Objects.equals(this.metadata, v1alpha1PodDisruptionBudget.metadata) &&
        Objects.equals(this.spec, v1alpha1PodDisruptionBudget.spec) &&
        Objects.equals(this.status, v1alpha1PodDisruptionBudget.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDisruptionBudget {\n");
