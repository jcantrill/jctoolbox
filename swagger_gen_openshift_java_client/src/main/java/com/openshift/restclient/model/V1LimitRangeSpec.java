...
import com.openshift.restclient.model.V1LimitRangeItem;
...
public class V1LimitRangeSpec   {
   ...
   * @return limits
  **/
  @ApiModelProperty(example = "null", required = true, value = "Limits is the list of LimitRangeItem objects that are enforced.")
