...
public class V1OwnerReference   {
   ...
   * @return apiVersion
  **/
  @ApiModelProperty(example = "null", required = true, value = "API version of the referent.")
   ...
   * @return controller
  **/
  @ApiModelProperty(example = "null", value = "If true, this reference points to the managing controller.")
   ...
   * @return kind
  **/
  @ApiModelProperty(example = "null", required = true, value = "Kind of the referent. More info: http://releases.k8s.io/release-1.4/docs/devel/api-conventions.md#types-kinds")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the referent. More info: http://releases.k8s.io/release-1.4/docs/user-guide/identifiers.md#names")
   ...
   * @return uid
  **/
  @ApiModelProperty(example = "null", required = true, value = "UID of the referent. More info: http://releases.k8s.io/release-1.4/docs/user-guide/identifiers.md#uids")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, controller, kind, name, uid);
  }
