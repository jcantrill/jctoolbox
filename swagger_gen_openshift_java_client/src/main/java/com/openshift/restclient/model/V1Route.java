...
import com.openshift.restclient.model.V1RouteSpec;
import com.openshift.restclient.model.V1RouteStatus;
...
public class V1Route   {
  ...
  private V1RouteStatus status = null;
  ...
  **/
  ...
  public V1Route spec(V1RouteSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  ...
  public V1Route status(V1RouteStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "")
  public V1RouteStatus getStatus() {
    return status;
  }

  public void setStatus(V1RouteStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1Route v1Route = (V1Route) o;
    return Objects.equals(this.apiVersion, v1Route.apiVersion) &&
        Objects.equals(this.kind, v1Route.kind) &&
        Objects.equals(this.metadata, v1Route.metadata) &&
        Objects.equals(this.spec, v1Route.spec) &&
        Objects.equals(this.status, v1Route.status);
  }
