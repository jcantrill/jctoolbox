...
public class V1PersistentVolumeClaimVolumeSource   {
   ...
   * @return claimName
  **/
  @ApiModelProperty(example = "null", required = true, value = "ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: http://releases.k8s.io/release-1.4/docs/user-guide/persistent-volumes.md#persistentvolumeclaims")
