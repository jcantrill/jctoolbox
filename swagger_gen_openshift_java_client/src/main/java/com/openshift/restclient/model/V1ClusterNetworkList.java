 ...
 */
@ApiModel(description = "ClusterNetworkList is a collection of ClusterNetworks")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ClusterNetworkList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1ClusterNetwork> items = new ArrayList<V1ClusterNetwork>();
  ...
  public V1ClusterNetworkList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ClusterNetworkList items(List<V1ClusterNetwork> items) {
    this.items = items;
    return this;
  }

  public V1ClusterNetworkList addItemsItem(V1ClusterNetwork itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of cluster networks")
  public List<V1ClusterNetwork> getItems() {
    return items;
  }

  public void setItems(List<V1ClusterNetwork> items) {
    this.items = items;
  }

  public V1ClusterNetworkList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterNetworkList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterNetworkList v1ClusterNetworkList = (V1ClusterNetworkList) o;
    return Objects.equals(this.apiVersion, v1ClusterNetworkList.apiVersion) &&
        Objects.equals(this.items, v1ClusterNetworkList.items) &&
        Objects.equals(this.kind, v1ClusterNetworkList.kind) &&
        Objects.equals(this.metadata, v1ClusterNetworkList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ClusterNetworkList {\n");
