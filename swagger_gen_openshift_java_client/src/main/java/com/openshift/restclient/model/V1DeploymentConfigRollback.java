...
import com.openshift.restclient.model.V1DeploymentConfigRollbackSpec;
...
public class V1DeploymentConfigRollback   {
  ...
  @SerializedName("spec")
  private V1DeploymentConfigRollbackSpec spec = null;

  @SerializedName("updatedAnnotations")
  private Object updatedAnnotations = null;

  public V1DeploymentConfigRollback apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1DeploymentConfigRollback kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1DeploymentConfigRollback name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the deployment config that will be rolled back.")
  ...
  public V1DeploymentConfigRollback spec(V1DeploymentConfigRollbackSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  ...
  public V1DeploymentConfigRollbackSpec getSpec() {
    return spec;
  }

  public void setSpec(V1DeploymentConfigRollbackSpec spec) {
    this.spec = spec;
  }

  public V1DeploymentConfigRollback updatedAnnotations(Object updatedAnnotations) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "UpdatedAnnotations is a set of new annotations that will be added in the deployment config.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1DeploymentConfigRollback v1DeploymentConfigRollback = (V1DeploymentConfigRollback) o;
    return Objects.equals(this.apiVersion, v1DeploymentConfigRollback.apiVersion) &&
        Objects.equals(this.kind, v1DeploymentConfigRollback.kind) &&
        Objects.equals(this.name, v1DeploymentConfigRollback.name) &&
        Objects.equals(this.spec, v1DeploymentConfigRollback.spec) &&
        Objects.equals(this.updatedAnnotations, v1DeploymentConfigRollback.updatedAnnotations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1DeploymentConfigRollback {\n");
