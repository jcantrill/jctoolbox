...
public class V1beta1IngressBackend   {
   ...
   * @return serviceName
  **/
  @ApiModelProperty(example = "null", required = true, value = "Specifies the name of the referenced service.")
  ...
  public V1beta1IngressBackend servicePort(String servicePort) {
   ...
   * @return servicePort
  **/
  @ApiModelProperty(example = "null", required = true, value = "Specifies the port of the referenced service.")
