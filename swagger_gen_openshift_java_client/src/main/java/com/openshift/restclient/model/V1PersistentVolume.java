...
import com.openshift.restclient.model.V1PersistentVolumeSpec;
import com.openshift.restclient.model.V1PersistentVolumeStatus;
 ...
 */
@ApiModel(description = "PersistentVolume (PV) is a storage resource provisioned by an administrator. It is analogous to a node. More info: http://releases.k8s.io/release-1.4/docs/user-guide/persistent-volumes.md")
