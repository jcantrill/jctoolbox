...
public class V1ImageList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of images")
  ...
  **/
  ...
  public V1ImageList metadata(UnversionedListMeta metadata) {
