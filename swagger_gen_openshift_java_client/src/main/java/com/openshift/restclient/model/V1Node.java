...
import com.openshift.restclient.model.V1NodeSpec;
import com.openshift.restclient.model.V1NodeStatus;
 ...
 */
@ApiModel(description = "Node is a worker node in Kubernetes, formerly known as minion. Each node will have a unique identifier in the cache (i.e. in etcd).")
