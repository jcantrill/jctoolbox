...
public class V1alpha1CertificateSigningRequestList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1alpha1CertificateSigningRequest> items = new ArrayList<V1alpha1CertificateSigningRequest>();
  ...
  public V1alpha1CertificateSigningRequestList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1CertificateSigningRequestList items(List<V1alpha1CertificateSigningRequest> items) {
    this.items = items;
    return this;
  }

  public V1alpha1CertificateSigningRequestList addItemsItem(V1alpha1CertificateSigningRequest itemsItem) {
  ...
  **/
  ...
  public List<V1alpha1CertificateSigningRequest> getItems() {
    return items;
  }

  public void setItems(List<V1alpha1CertificateSigningRequest> items) {
    this.items = items;
  }

  public V1alpha1CertificateSigningRequestList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1alpha1CertificateSigningRequestList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1CertificateSigningRequestList v1alpha1CertificateSigningRequestList = (V1alpha1CertificateSigningRequestList) o;
    return Objects.equals(this.apiVersion, v1alpha1CertificateSigningRequestList.apiVersion) &&
        Objects.equals(this.items, v1alpha1CertificateSigningRequestList.items) &&
        Objects.equals(this.kind, v1alpha1CertificateSigningRequestList.kind) &&
        Objects.equals(this.metadata, v1alpha1CertificateSigningRequestList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1CertificateSigningRequestList {\n");
