...
public class V1SecretVolumeSource   {
  ...
  **/
   ...
   * @return secretName
  **/
  @ApiModelProperty(example = "null", value = "Name of the secret in the pod's namespace to use. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#secrets")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultMode, items, secretName);
  }
