...
public class V1PodCondition   {
  ...
  public V1PodCondition lastProbeTime(String lastProbeTime) {
  ...
  **/
  ...
  public V1PodCondition lastTransitionTime(String lastTransitionTime) {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", required = true, value = "Status is the status of the condition. Can be True, False, Unknown. More info: http://releases.k8s.io/release-1.4/docs/user-guide/pod-states.md#pod-conditions")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type is the type of the condition. Currently only Ready. More info: http://releases.k8s.io/release-1.4/docs/user-guide/pod-states.md#pod-conditions")
