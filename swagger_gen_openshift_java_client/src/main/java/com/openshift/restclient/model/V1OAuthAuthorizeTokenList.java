...
public class V1OAuthAuthorizeTokenList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1OAuthAuthorizeToken> items = new ArrayList<V1OAuthAuthorizeToken>();
  ...
  public V1OAuthAuthorizeTokenList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthAuthorizeTokenList items(List<V1OAuthAuthorizeToken> items) {
    this.items = items;
    return this;
  }

  public V1OAuthAuthorizeTokenList addItemsItem(V1OAuthAuthorizeToken itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of OAuth authorization tokens")
  public List<V1OAuthAuthorizeToken> getItems() {
    return items;
  }

  public void setItems(List<V1OAuthAuthorizeToken> items) {
    this.items = items;
  }

  public V1OAuthAuthorizeTokenList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthAuthorizeTokenList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthAuthorizeTokenList v1OAuthAuthorizeTokenList = (V1OAuthAuthorizeTokenList) o;
    return Objects.equals(this.apiVersion, v1OAuthAuthorizeTokenList.apiVersion) &&
        Objects.equals(this.items, v1OAuthAuthorizeTokenList.items) &&
        Objects.equals(this.kind, v1OAuthAuthorizeTokenList.kind) &&
        Objects.equals(this.metadata, v1OAuthAuthorizeTokenList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1OAuthAuthorizeTokenList {\n");
