...
public class V1ResourceQuotaList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of ResourceQuota objects. More info: http://releases.k8s.io/release-1.4/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota")
  ...
  **/
  ...
  public V1ResourceQuotaList metadata(UnversionedListMeta metadata) {
