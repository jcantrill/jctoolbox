...
import com.openshift.restclient.model.V1NamedRoleBinding;
 ...
 */
@ApiModel(description = "PolicyBinding is a object that holds all the RoleBindings for a particular namespace.  There is one PolicyBinding document per referenced Policy namespace")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1PolicyBinding   {
  ...
  private List<V1NamedRoleBinding> roleBindings = new ArrayList<V1NamedRoleBinding>();

  public V1PolicyBinding apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1PolicyBinding kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1PolicyBinding lastModified(String lastModified) {
   ...
   * @return lastModified
  **/
  @ApiModelProperty(example = "null", required = true, value = "LastModified is the last time that any part of the PolicyBinding was created, updated, or deleted")
  ...
  public V1PolicyBinding metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1PolicyBinding policyRef(V1ObjectReference policyRef) {
  ...
  **/
  ...
  public V1PolicyBinding roleBindings(List<V1NamedRoleBinding> roleBindings) {
    this.roleBindings = roleBindings;
    return this;
  }

  public V1PolicyBinding addRoleBindingsItem(V1NamedRoleBinding roleBindingsItem) {
   ...
   * @return roleBindings
  **/
  @ApiModelProperty(example = "null", required = true, value = "RoleBindings holds all the RoleBindings held by this PolicyBinding, mapped by RoleBinding.Name")
  public List<V1NamedRoleBinding> getRoleBindings() {
    return roleBindings;
  }

  public void setRoleBindings(List<V1NamedRoleBinding> roleBindings) {
    this.roleBindings = roleBindings;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PolicyBinding v1PolicyBinding = (V1PolicyBinding) o;
    return Objects.equals(this.apiVersion, v1PolicyBinding.apiVersion) &&
        Objects.equals(this.kind, v1PolicyBinding.kind) &&
        Objects.equals(this.lastModified, v1PolicyBinding.lastModified) &&
        Objects.equals(this.metadata, v1PolicyBinding.metadata) &&
        Objects.equals(this.policyRef, v1PolicyBinding.policyRef) &&
        Objects.equals(this.roleBindings, v1PolicyBinding.roleBindings);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PolicyBinding {\n");
