...
public class V1OAuthAccessTokenList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1OAuthAccessToken> items = new ArrayList<V1OAuthAccessToken>();
  ...
  public V1OAuthAccessTokenList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthAccessTokenList items(List<V1OAuthAccessToken> items) {
    this.items = items;
    return this;
  }

  public V1OAuthAccessTokenList addItemsItem(V1OAuthAccessToken itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of OAuth access tokens")
  public List<V1OAuthAccessToken> getItems() {
    return items;
  }

  public void setItems(List<V1OAuthAccessToken> items) {
    this.items = items;
  }

  public V1OAuthAccessTokenList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthAccessTokenList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthAccessTokenList v1OAuthAccessTokenList = (V1OAuthAccessTokenList) o;
    return Objects.equals(this.apiVersion, v1OAuthAccessTokenList.apiVersion) &&
        Objects.equals(this.items, v1OAuthAccessTokenList.items) &&
        Objects.equals(this.kind, v1OAuthAccessTokenList.kind) &&
        Objects.equals(this.metadata, v1OAuthAccessTokenList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1OAuthAccessTokenList {\n");
