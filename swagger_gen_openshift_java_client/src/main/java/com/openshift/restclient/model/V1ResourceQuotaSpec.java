...
import com.openshift.restclient.model.V1ResourceQuotaScope;
...
public class V1ResourceQuotaSpec   {
  @SerializedName("hard")
  private Object hard = null;

  @SerializedName("scopes")
  private List<V1ResourceQuotaScope> scopes = new ArrayList<V1ResourceQuotaScope>();

  public V1ResourceQuotaSpec hard(Object hard) {
    this.hard = hard;
    return this;
  }
   ...
   * @return hard
  **/
  @ApiModelProperty(example = "null", value = "Hard is the set of desired hard limits for each named resource. More info: http://releases.k8s.io/release-1.4/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota")
  ...
  public V1ResourceQuotaSpec scopes(List<V1ResourceQuotaScope> scopes) {
    this.scopes = scopes;
    return this;
  }

  public V1ResourceQuotaSpec addScopesItem(V1ResourceQuotaScope scopesItem) {
  ...
  **/
  ...
  public List<V1ResourceQuotaScope> getScopes() {
    return scopes;
  }

  public void setScopes(List<V1ResourceQuotaScope> scopes) {
    this.scopes = scopes;
  }
