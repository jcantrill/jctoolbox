...
public class V1NamespaceStatus   {
   ...
   * @return phase
  **/
  @ApiModelProperty(example = "null", value = "Phase is the current lifecycle phase of the namespace. More info: http://releases.k8s.io/release-1.4/docs/design/namespaces.md#phases")
