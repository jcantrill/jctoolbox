...
public class V1Group   {
  ...
  public V1Group apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Group kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1Group metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Group users(List<String> users) {
    this.users = users;
    return this;
  }

  public V1Group addUsersItem(String usersItem) {
   ...
   * @return users
  **/
  @ApiModelProperty(example = "null", required = true, value = "Users is the list of users in this group.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1Group v1Group = (V1Group) o;
    return Objects.equals(this.apiVersion, v1Group.apiVersion) &&
        Objects.equals(this.kind, v1Group.kind) &&
        Objects.equals(this.metadata, v1Group.metadata) &&
        Objects.equals(this.users, v1Group.users);
  }
