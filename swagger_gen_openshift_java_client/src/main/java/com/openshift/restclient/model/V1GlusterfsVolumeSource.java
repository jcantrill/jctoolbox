...
public class V1GlusterfsVolumeSource   {
   ...
   * @return endpoints
  **/
  @ApiModelProperty(example = "null", required = true, value = "EndpointsName is the endpoint name that details Glusterfs topology. More info: http://releases.k8s.io/release-1.4/examples/volumes/glusterfs/README.md#create-a-pod")
   ...
   * @return path
  **/
  @ApiModelProperty(example = "null", required = true, value = "Path is the Glusterfs volume path. More info: http://releases.k8s.io/release-1.4/examples/volumes/glusterfs/README.md#create-a-pod")
   ...
   * @return readOnly
  **/
  @ApiModelProperty(example = "null", value = "ReadOnly here will force the Glusterfs volume to be mounted with read-only permissions. Defaults to false. More info: http://releases.k8s.io/release-1.4/examples/volumes/glusterfs/README.md#create-a-pod")
