...
public class V1beta1HorizontalPodAutoscalerList   {
  ...
  private List<V1beta1HorizontalPodAutoscaler> items = new ArrayList<V1beta1HorizontalPodAutoscaler>();
  ...
  public V1beta1HorizontalPodAutoscalerList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1beta1HorizontalPodAutoscalerList items(List<V1beta1HorizontalPodAutoscaler> items) {
    this.items = items;
    return this;
  }

  public V1beta1HorizontalPodAutoscalerList addItemsItem(V1beta1HorizontalPodAutoscaler itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "list of horizontal pod autoscaler objects.")
  public List<V1beta1HorizontalPodAutoscaler> getItems() {
    return items;
  }

  public void setItems(List<V1beta1HorizontalPodAutoscaler> items) {
    this.items = items;
  }

  public V1beta1HorizontalPodAutoscalerList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1beta1HorizontalPodAutoscalerList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1HorizontalPodAutoscalerList v1beta1HorizontalPodAutoscalerList = (V1beta1HorizontalPodAutoscalerList) o;
    return Objects.equals(this.apiVersion, v1beta1HorizontalPodAutoscalerList.apiVersion) &&
        Objects.equals(this.items, v1beta1HorizontalPodAutoscalerList.items) &&
        Objects.equals(this.kind, v1beta1HorizontalPodAutoscalerList.kind) &&
        Objects.equals(this.metadata, v1beta1HorizontalPodAutoscalerList.metadata);
  }
