...
import com.openshift.restclient.model.V2alpha1ScheduledJobSpec;
import com.openshift.restclient.model.V2alpha1ScheduledJobStatus;
 ...
 */
@ApiModel(description = "ScheduledJob represents the configuration of a single scheduled job.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V2alpha1ScheduledJob   {
  ...
  @SerializedName("spec")
  private V2alpha1ScheduledJobSpec spec = null;

  @SerializedName("status")
  private V2alpha1ScheduledJobStatus status = null;

  public V2alpha1ScheduledJob apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V2alpha1ScheduledJob kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V2alpha1ScheduledJob metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V2alpha1ScheduledJob spec(V2alpha1ScheduledJobSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V2alpha1ScheduledJobSpec getSpec() {
    return spec;
  }

  public void setSpec(V2alpha1ScheduledJobSpec spec) {
    this.spec = spec;
  }

  public V2alpha1ScheduledJob status(V2alpha1ScheduledJobStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V2alpha1ScheduledJobStatus getStatus() {
    return status;
  }

  public void setStatus(V2alpha1ScheduledJobStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2alpha1ScheduledJob v2alpha1ScheduledJob = (V2alpha1ScheduledJob) o;
    return Objects.equals(this.apiVersion, v2alpha1ScheduledJob.apiVersion) &&
        Objects.equals(this.kind, v2alpha1ScheduledJob.kind) &&
        Objects.equals(this.metadata, v2alpha1ScheduledJob.metadata) &&
        Objects.equals(this.spec, v2alpha1ScheduledJob.spec) &&
        Objects.equals(this.status, v2alpha1ScheduledJob.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2alpha1ScheduledJob {\n");
