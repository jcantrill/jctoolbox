...
import com.openshift.restclient.model.V1beta1HTTPIngressPath;
...
public class V1beta1HTTPIngressRuleValue   {
   ...
   * @return paths
  **/
  @ApiModelProperty(example = "null", required = true, value = "A collection of paths that map requests to backends.")
