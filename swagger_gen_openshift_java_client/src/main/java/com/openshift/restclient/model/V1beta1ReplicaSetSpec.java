...
public class V1beta1ReplicaSetSpec   {
   ...
   * @return replicas
  **/
  @ApiModelProperty(example = "null", value = "Replicas is the number of desired replicas. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1. More info: http://releases.k8s.io/release-1.4/docs/user-guide/replication-controller.md#what-is-a-replication-controller")
  ...
  public V1beta1ReplicaSetSpec selector(V1beta1LabelSelector selector) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.replicas, v1beta1ReplicaSetSpec.replicas) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(replicas, selector, template);
  }
