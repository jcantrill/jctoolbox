 ...
 */
@ApiModel(description = "HostSubnetList is a collection of HostSubnets")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1HostSubnetList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1HostSubnet> items = new ArrayList<V1HostSubnet>();
  ...
  public V1HostSubnetList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1HostSubnetList items(List<V1HostSubnet> items) {
    this.items = items;
    return this;
  }

  public V1HostSubnetList addItemsItem(V1HostSubnet itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of host subnets")
  public List<V1HostSubnet> getItems() {
    return items;
  }

  public void setItems(List<V1HostSubnet> items) {
    this.items = items;
  }

  public V1HostSubnetList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1HostSubnetList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1HostSubnetList v1HostSubnetList = (V1HostSubnetList) o;
    return Objects.equals(this.apiVersion, v1HostSubnetList.apiVersion) &&
        Objects.equals(this.items, v1HostSubnetList.items) &&
        Objects.equals(this.kind, v1HostSubnetList.kind) &&
        Objects.equals(this.metadata, v1HostSubnetList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1HostSubnetList {\n");
