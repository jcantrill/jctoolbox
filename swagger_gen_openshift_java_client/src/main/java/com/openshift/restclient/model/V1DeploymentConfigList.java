...
public class V1DeploymentConfigList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1DeploymentConfig> items = new ArrayList<V1DeploymentConfig>();
  ...
  public V1DeploymentConfigList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1DeploymentConfigList items(List<V1DeploymentConfig> items) {
    this.items = items;
    return this;
  }

  public V1DeploymentConfigList addItemsItem(V1DeploymentConfig itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of deployment configs")
  public List<V1DeploymentConfig> getItems() {
    return items;
  }

  public void setItems(List<V1DeploymentConfig> items) {
    this.items = items;
  }

  public V1DeploymentConfigList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1DeploymentConfigList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1DeploymentConfigList v1DeploymentConfigList = (V1DeploymentConfigList) o;
    return Objects.equals(this.apiVersion, v1DeploymentConfigList.apiVersion) &&
        Objects.equals(this.items, v1DeploymentConfigList.items) &&
        Objects.equals(this.kind, v1DeploymentConfigList.kind) &&
        Objects.equals(this.metadata, v1DeploymentConfigList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1DeploymentConfigList {\n");
