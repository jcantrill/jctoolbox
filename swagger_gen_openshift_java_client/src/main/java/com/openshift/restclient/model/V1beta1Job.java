...
import com.openshift.restclient.model.V1beta1JobSpec;
import com.openshift.restclient.model.V1beta1JobStatus;
...
public class V1beta1Job   {
  ...
  @SerializedName("spec")
  private V1beta1JobSpec spec = null;

  @SerializedName("status")
  private V1beta1JobStatus status = null;

  public V1beta1Job apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1beta1Job kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1beta1Job metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1beta1Job spec(V1beta1JobSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1beta1JobSpec getSpec() {
    return spec;
  }

  public void setSpec(V1beta1JobSpec spec) {
    this.spec = spec;
  }

  public V1beta1Job status(V1beta1JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1beta1JobStatus getStatus() {
    return status;
  }

  public void setStatus(V1beta1JobStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1Job v1beta1Job = (V1beta1Job) o;
    return Objects.equals(this.apiVersion, v1beta1Job.apiVersion) &&
        Objects.equals(this.kind, v1beta1Job.kind) &&
        Objects.equals(this.metadata, v1beta1Job.metadata) &&
        Objects.equals(this.spec, v1beta1Job.spec) &&
        Objects.equals(this.status, v1beta1Job.status);
  }
