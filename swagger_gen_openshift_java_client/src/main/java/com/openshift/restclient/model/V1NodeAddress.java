...
public class V1NodeAddress   {
   ...
   * @return address
  **/
  @ApiModelProperty(example = "null", required = true, value = "The node address.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Node address type, one of Hostname, ExternalIP or InternalIP.")
