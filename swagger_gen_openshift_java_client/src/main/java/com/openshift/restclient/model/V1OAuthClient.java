...
import com.openshift.restclient.model.V1ScopeRestriction;
...
public class V1OAuthClient   {
  ...
  private List<V1ScopeRestriction> scopeRestrictions = new ArrayList<V1ScopeRestriction>();

  @SerializedName("secret")
  private String secret = null;

  public V1OAuthClient additionalSecrets(List<String> additionalSecrets) {
    this.additionalSecrets = additionalSecrets;
    return this;
  }

  public V1OAuthClient addAdditionalSecretsItem(String additionalSecretsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "AdditionalSecrets holds other secrets that may be used to identify the client.  This is useful for rotation and for service account token validation")
  ...
  public V1OAuthClient apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthClient grantMethod(String grantMethod) {
   ...
   * @return grantMethod
  **/
  @ApiModelProperty(example = "null", value = "GrantMethod determines how to handle grants for this client. If no method is provided, the cluster default grant handling method will be used. Valid grant handling methods are:  - auto:   always approves grant requests, useful for trusted clients  - prompt: prompts the end user for approval of grant requests, useful for third-party clients  - deny:   always denies grant requests, useful for black-listed clients")
  ...
  public V1OAuthClient kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthClient metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1OAuthClient redirectURIs(List<String> redirectURIs) {
    this.redirectURIs = redirectURIs;
    return this;
  }

  public V1OAuthClient addRedirectURIsItem(String redirectURIsItem) {
   ...
   * @return redirectURIs
  **/
  @ApiModelProperty(example = "null", value = "RedirectURIs is the valid redirection URIs associated with a client")
  ...
  public V1OAuthClient respondWithChallenges(Boolean respondWithChallenges) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "RespondWithChallenges indicates whether the client wants authentication needed responses made in the form of challenges instead of redirects")
  ...
  public V1OAuthClient scopeRestrictions(List<V1ScopeRestriction> scopeRestrictions) {
    this.scopeRestrictions = scopeRestrictions;
    return this;
  }

  public V1OAuthClient addScopeRestrictionsItem(V1ScopeRestriction scopeRestrictionsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "ScopeRestrictions describes which scopes this client can request.  Each requested scope is checked against each restriction.  If any restriction matches, then the scope is allowed. If no restriction matches, then the scope is denied.")
  public List<V1ScopeRestriction> getScopeRestrictions() {
    return scopeRestrictions;
  }

  public void setScopeRestrictions(List<V1ScopeRestriction> scopeRestrictions) {
    this.scopeRestrictions = scopeRestrictions;
  }

  public V1OAuthClient secret(String secret) {
    this.secret = secret;
    return this;
  }
   ...
   * @return secret
  **/
  @ApiModelProperty(example = "null", value = "Secret is the unique secret associated with a client")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthClient v1OAuthClient = (V1OAuthClient) o;
    return Objects.equals(this.additionalSecrets, v1OAuthClient.additionalSecrets) &&
        Objects.equals(this.apiVersion, v1OAuthClient.apiVersion) &&
        Objects.equals(this.grantMethod, v1OAuthClient.grantMethod) &&
        Objects.equals(this.kind, v1OAuthClient.kind) &&
        Objects.equals(this.metadata, v1OAuthClient.metadata) &&
        Objects.equals(this.redirectURIs, v1OAuthClient.redirectURIs) &&
        Objects.equals(this.respondWithChallenges, v1OAuthClient.respondWithChallenges) &&
        Objects.equals(this.scopeRestrictions, v1OAuthClient.scopeRestrictions) &&
        Objects.equals(this.secret, v1OAuthClient.secret);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalSecrets, apiVersion, grantMethod, kind, metadata, redirectURIs, respondWithChallenges, scopeRestrictions, secret);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1OAuthClient {\n");
