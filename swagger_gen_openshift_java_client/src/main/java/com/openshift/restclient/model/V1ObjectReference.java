...
public class V1ObjectReference   {
  ...
  **/
   ...
   * @return fieldPath
  **/
  @ApiModelProperty(example = "null", value = "If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: \"spec.containers{name}\" (where \"name\" refers to the name of the container that triggered the event) or if no container name is specified \"spec.containers[2]\" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.")
   ...
   * @return kind
  **/
  @ApiModelProperty(example = "null", value = "Kind of the referent. More info: http://releases.k8s.io/release-1.4/docs/devel/api-conventions.md#types-kinds")
  ...
  **/
   ...
   * @return namespace
  **/
  @ApiModelProperty(example = "null", value = "Namespace of the referent. More info: http://releases.k8s.io/release-1.4/docs/user-guide/namespaces.md")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Specific resourceVersion to which this reference is made, if any. More info: http://releases.k8s.io/release-1.4/docs/devel/api-conventions.md#concurrency-control-and-consistency")
   ...
   * @return uid
  **/
  @ApiModelProperty(example = "null", value = "UID of the referent. More info: http://releases.k8s.io/release-1.4/docs/user-guide/identifiers.md#uids")
