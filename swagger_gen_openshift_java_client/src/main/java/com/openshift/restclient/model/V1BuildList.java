...
public class V1BuildList   {
  ...
  public V1BuildList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1BuildList items(List<V1Build> items) {
    this.items = items;
    return this;
  }

  public V1BuildList addItemsItem(V1Build itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "items is a list of builds")
  public List<V1Build> getItems() {
    return items;
  }

  public void setItems(List<V1Build> items) {
    this.items = items;
  }

  public V1BuildList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1BuildList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1BuildList v1BuildList = (V1BuildList) o;
    return Objects.equals(this.apiVersion, v1BuildList.apiVersion) &&
        Objects.equals(this.items, v1BuildList.items) &&
        Objects.equals(this.kind, v1BuildList.kind) &&
        Objects.equals(this.metadata, v1BuildList.metadata);
  }
