...
import com.openshift.restclient.model.V1FinalizerName;
...
public class V1NamespaceSpec   {
  ...
  private List<V1FinalizerName> finalizers = new ArrayList<V1FinalizerName>();

  public V1NamespaceSpec finalizers(List<V1FinalizerName> finalizers) {
    this.finalizers = finalizers;
    return this;
  }

  public V1NamespaceSpec addFinalizersItem(V1FinalizerName finalizersItem) {
   ...
   * @return finalizers
  **/
  @ApiModelProperty(example = "null", value = "Finalizers is an opaque list of values that must be empty to permanently remove object from storage. More info: http://releases.k8s.io/release-1.4/docs/design/namespaces.md#finalizers")
  public List<V1FinalizerName> getFinalizers() {
    return finalizers;
  }

  public void setFinalizers(List<V1FinalizerName> finalizers) {
    this.finalizers = finalizers;
  }
