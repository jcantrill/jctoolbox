...
import com.openshift.restclient.model.V1NamedClusterRole;
 ...
 */
@ApiModel(description = "ClusterPolicy is a object that holds all the ClusterRoles for a particular namespace.  There is at most one ClusterPolicy document per namespace.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ClusterPolicy   {
  ...
  private List<V1NamedClusterRole> roles = new ArrayList<V1NamedClusterRole>();

  public V1ClusterPolicy apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ClusterPolicy kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterPolicy lastModified(String lastModified) {
   ...
   * @return lastModified
  **/
  @ApiModelProperty(example = "null", required = true, value = "LastModified is the last time that any part of the ClusterPolicy was created, updated, or deleted")
  ...
  public V1ClusterPolicy metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1ClusterPolicy roles(List<V1NamedClusterRole> roles) {
    this.roles = roles;
    return this;
  }

  public V1ClusterPolicy addRolesItem(V1NamedClusterRole rolesItem) {
   ...
   * @return roles
  **/
  @ApiModelProperty(example = "null", required = true, value = "Roles holds all the ClusterRoles held by this ClusterPolicy, mapped by ClusterRole.Name")
  public List<V1NamedClusterRole> getRoles() {
    return roles;
  }

  public void setRoles(List<V1NamedClusterRole> roles) {
    this.roles = roles;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterPolicy v1ClusterPolicy = (V1ClusterPolicy) o;
    return Objects.equals(this.apiVersion, v1ClusterPolicy.apiVersion) &&
        Objects.equals(this.kind, v1ClusterPolicy.kind) &&
        Objects.equals(this.lastModified, v1ClusterPolicy.lastModified) &&
        Objects.equals(this.metadata, v1ClusterPolicy.metadata) &&
        Objects.equals(this.roles, v1ClusterPolicy.roles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, kind, lastModified, metadata, roles);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ClusterPolicy {\n");
