...
public class V1NodeSpec   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Unschedulable controls node schedulability of new pods. By default, node is schedulable. More info: http://releases.k8s.io/release-1.4/docs/admin/node.md#manual-node-administration\"`")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(externalID, podCIDR, providerID, unschedulable);
  }
