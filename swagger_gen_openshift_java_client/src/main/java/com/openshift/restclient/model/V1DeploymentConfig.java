...
import com.openshift.restclient.model.V1DeploymentConfigSpec;
import com.openshift.restclient.model.V1DeploymentConfigStatus;
...
public class V1DeploymentConfig   {
  ...
  @SerializedName("spec")
  private V1DeploymentConfigSpec spec = null;

  @SerializedName("status")
  private V1DeploymentConfigStatus status = null;

  public V1DeploymentConfig apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1DeploymentConfig kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1DeploymentConfig metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1DeploymentConfig spec(V1DeploymentConfigSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  ...
  public V1DeploymentConfigSpec getSpec() {
    return spec;
  }

  public void setSpec(V1DeploymentConfigSpec spec) {
    this.spec = spec;
  }

  public V1DeploymentConfig status(V1DeploymentConfigStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "")
  public V1DeploymentConfigStatus getStatus() {
    return status;
  }

  public void setStatus(V1DeploymentConfigStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1DeploymentConfig v1DeploymentConfig = (V1DeploymentConfig) o;
    return Objects.equals(this.apiVersion, v1DeploymentConfig.apiVersion) &&
        Objects.equals(this.kind, v1DeploymentConfig.kind) &&
        Objects.equals(this.metadata, v1DeploymentConfig.metadata) &&
        Objects.equals(this.spec, v1DeploymentConfig.spec) &&
        Objects.equals(this.status, v1DeploymentConfig.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1DeploymentConfig {\n");
