...
public class V1SecretBuildSource   {
  ...
  public V1SecretBuildSource destinationDir(String destinationDir) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "destinationDir is the directory where the files from the secret should be available for the build time. For the Source build strategy, these will be injected into a container where the assemble script runs. Later, when the script finishes, all files injected will be truncated to zero length. For the Docker build strategy, these will be copied into the build directory, where the Dockerfile is located, so users can ADD or COPY them during docker build.")
  ...
  public V1SecretBuildSource secret(V1LocalObjectReference secret) {
    this.secret = secret;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1SecretBuildSource v1SecretBuildSource = (V1SecretBuildSource) o;
    return Objects.equals(this.destinationDir, v1SecretBuildSource.destinationDir) &&
        Objects.equals(this.secret, v1SecretBuildSource.secret);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1SecretBuildSource {\n");
