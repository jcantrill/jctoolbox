 ...
 */
@ApiModel(description = "JenkinsPipelineBuildStrategy holds parameters specific to a Jenkins Pipeline build. This strategy is in tech preview.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1JenkinsPipelineBuildStrategy   {
  ...
  public V1JenkinsPipelineBuildStrategy jenkinsfile(String jenkinsfile) {
   ...
   * @return jenkinsfile
  **/
  @ApiModelProperty(example = "null", value = "Jenkinsfile defines the optional raw contents of a Jenkinsfile which defines a Jenkins pipeline build.")
  ...
  public V1JenkinsPipelineBuildStrategy jenkinsfilePath(String jenkinsfilePath) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "JenkinsfilePath is the optional path of the Jenkinsfile that will be used to configure the pipeline relative to the root of the context (contextDir). If both JenkinsfilePath & Jenkinsfile are both not specified, this defaults to Jenkinsfile in the root of the specified contextDir.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1JenkinsPipelineBuildStrategy v1JenkinsPipelineBuildStrategy = (V1JenkinsPipelineBuildStrategy) o;
    return Objects.equals(this.jenkinsfile, v1JenkinsPipelineBuildStrategy.jenkinsfile) &&
        Objects.equals(this.jenkinsfilePath, v1JenkinsPipelineBuildStrategy.jenkinsfilePath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jenkinsfile, jenkinsfilePath);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1JenkinsPipelineBuildStrategy {\n");
