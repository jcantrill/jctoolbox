...
public class V1NFSVolumeSource   {
   ...
   * @return path
  **/
  @ApiModelProperty(example = "null", required = true, value = "Path that is exported by the NFS server. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#nfs")
   ...
   * @return readOnly
  **/
  @ApiModelProperty(example = "null", value = "ReadOnly here will force the NFS export to be mounted with read-only permissions. Defaults to false. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#nfs")
   ...
   * @return server
  **/
  @ApiModelProperty(example = "null", required = true, value = "Server is the hostname or IP address of the NFS server. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#nfs")
