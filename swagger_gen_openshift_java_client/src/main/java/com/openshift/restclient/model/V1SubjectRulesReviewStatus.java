...
import com.openshift.restclient.model.V1PolicyRule;
...
public class V1SubjectRulesReviewStatus   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "EvaluationError can appear in combination with Rules.  It means some error happened during evaluation that may have prevented additional rules from being populated.")
  ...
  public V1SubjectRulesReviewStatus rules(List<V1PolicyRule> rules) {
    this.rules = rules;
    return this;
  }

  public V1SubjectRulesReviewStatus addRulesItem(V1PolicyRule rulesItem) {
   ...
   * @return rules
  **/
  @ApiModelProperty(example = "null", required = true, value = "Rules is the list of rules (no particular sort) that are allowed for the subject")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.evaluationError, v1SubjectRulesReviewStatus.evaluationError) &&
        Objects.equals(this.rules, v1SubjectRulesReviewStatus.rules);
  }
