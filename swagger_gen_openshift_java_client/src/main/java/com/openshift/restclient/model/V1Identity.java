...
public class V1Identity   {
  ...
  @SerializedName("user")
  private V1ObjectReference user = null;

  public V1Identity apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Identity extra(Object extra) {
    this.extra = extra;
    return this;
  }
   ...
   * @return extra
  **/
  @ApiModelProperty(example = "null", value = "Extra holds extra information about this identity")
  ...
  public V1Identity kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1Identity metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Identity providerName(String providerName) {
   ...
   * @return providerName
  **/
  @ApiModelProperty(example = "null", required = true, value = "ProviderName is the source of identity information")
  ...
  public V1Identity providerUserName(String providerUserName) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "ProviderUserName uniquely represents this identity in the scope of the provider")
  ...
  public V1Identity user(V1ObjectReference user) {
    this.user = user;
    return this;
  }
  ...
  **/
  ...
  public V1ObjectReference getUser() {
    return user;
  }

  public void setUser(V1ObjectReference user) {
    this.user = user;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1Identity v1Identity = (V1Identity) o;
    return Objects.equals(this.apiVersion, v1Identity.apiVersion) &&
        Objects.equals(this.extra, v1Identity.extra) &&
        Objects.equals(this.kind, v1Identity.kind) &&
        Objects.equals(this.metadata, v1Identity.metadata) &&
        Objects.equals(this.providerName, v1Identity.providerName) &&
        Objects.equals(this.providerUserName, v1Identity.providerUserName) &&
        Objects.equals(this.user, v1Identity.user);
  }
