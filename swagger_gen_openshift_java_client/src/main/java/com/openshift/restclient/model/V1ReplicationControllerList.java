...
public class V1ReplicationControllerList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of replication controllers. More info: http://releases.k8s.io/release-1.4/docs/user-guide/replication-controller.md")
  ...
  **/
  ...
  public V1ReplicationControllerList metadata(UnversionedListMeta metadata) {
