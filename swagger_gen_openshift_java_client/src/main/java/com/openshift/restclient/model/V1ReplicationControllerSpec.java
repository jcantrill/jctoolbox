...
public class V1ReplicationControllerSpec   {
  ...
  **/
  ...
  public V1ReplicationControllerSpec selector(Object selector) {
   ...
   * @return selector
  **/
  @ApiModelProperty(example = "null", value = "Selector is a label query over pods that should match the Replicas count. If Selector is empty, it is defaulted to the labels present on the Pod template. Label keys and values that must match in order to be controlled by this replication controller, if empty defaulted to labels on Pod template. More info: http://releases.k8s.io/release-1.4/docs/user-guide/labels.md#label-selectors")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.replicas, v1ReplicationControllerSpec.replicas) &&
