...
import com.openshift.restclient.model.UnversionedListMeta;
 ...
 */
@ApiModel(description = "AppliedClusterResourceQuotaList is a collection of AppliedClusterResourceQuotas")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1AppliedClusterResourceQuotaList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1AppliedClusterResourceQuota> items = new ArrayList<V1AppliedClusterResourceQuota>();
  ...
  public V1AppliedClusterResourceQuotaList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1AppliedClusterResourceQuotaList items(List<V1AppliedClusterResourceQuota> items) {
    this.items = items;
    return this;
  }

  public V1AppliedClusterResourceQuotaList addItemsItem(V1AppliedClusterResourceQuota itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of AppliedClusterResourceQuota")
  public List<V1AppliedClusterResourceQuota> getItems() {
    return items;
  }

  public void setItems(List<V1AppliedClusterResourceQuota> items) {
    this.items = items;
  }

  public V1AppliedClusterResourceQuotaList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1AppliedClusterResourceQuotaList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1AppliedClusterResourceQuotaList v1AppliedClusterResourceQuotaList = (V1AppliedClusterResourceQuotaList) o;
    return Objects.equals(this.apiVersion, v1AppliedClusterResourceQuotaList.apiVersion) &&
        Objects.equals(this.items, v1AppliedClusterResourceQuotaList.items) &&
        Objects.equals(this.kind, v1AppliedClusterResourceQuotaList.kind) &&
        Objects.equals(this.metadata, v1AppliedClusterResourceQuotaList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1AppliedClusterResourceQuotaList {\n");
