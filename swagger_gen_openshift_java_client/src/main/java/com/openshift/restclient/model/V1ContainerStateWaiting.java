...
public class V1ContainerStateWaiting   {
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "Message regarding why the container is not yet running.")
   ...
   * @return reason
  **/
  @ApiModelProperty(example = "null", value = "(brief) reason the container is not yet running.")
