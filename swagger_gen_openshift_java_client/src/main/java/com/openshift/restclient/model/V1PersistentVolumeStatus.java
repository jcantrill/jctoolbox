...
public class V1PersistentVolumeStatus   {
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "A human-readable message indicating details about why the volume is in this state.")
   ...
   * @return phase
  **/
  @ApiModelProperty(example = "null", value = "Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: http://releases.k8s.io/release-1.4/docs/user-guide/persistent-volumes.md#phase")
