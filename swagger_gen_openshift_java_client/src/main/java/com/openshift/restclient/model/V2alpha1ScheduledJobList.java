 ...
 */
@ApiModel(description = "ScheduledJobList is a collection of scheduled jobs.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V2alpha1ScheduledJobList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V2alpha1ScheduledJob> items = new ArrayList<V2alpha1ScheduledJob>();
  ...
  public V2alpha1ScheduledJobList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V2alpha1ScheduledJobList items(List<V2alpha1ScheduledJob> items) {
    this.items = items;
    return this;
  }

  public V2alpha1ScheduledJobList addItemsItem(V2alpha1ScheduledJob itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of ScheduledJob.")
  public List<V2alpha1ScheduledJob> getItems() {
    return items;
  }

  public void setItems(List<V2alpha1ScheduledJob> items) {
    this.items = items;
  }

  public V2alpha1ScheduledJobList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V2alpha1ScheduledJobList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2alpha1ScheduledJobList v2alpha1ScheduledJobList = (V2alpha1ScheduledJobList) o;
    return Objects.equals(this.apiVersion, v2alpha1ScheduledJobList.apiVersion) &&
        Objects.equals(this.items, v2alpha1ScheduledJobList.items) &&
        Objects.equals(this.kind, v2alpha1ScheduledJobList.kind) &&
        Objects.equals(this.metadata, v2alpha1ScheduledJobList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V2alpha1ScheduledJobList {\n");
