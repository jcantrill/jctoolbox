...
public class V1ProjectRequest   {
  ...
  public V1ProjectRequest apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ProjectRequest description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", value = "Description is the description to apply to a project")
  ...
  public V1ProjectRequest displayName(String displayName) {
   ...
   * @return displayName
  **/
  @ApiModelProperty(example = "null", value = "DisplayName is the display name to apply to a project")
  ...
  public V1ProjectRequest kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ProjectRequest metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ProjectRequest v1ProjectRequest = (V1ProjectRequest) o;
    return Objects.equals(this.apiVersion, v1ProjectRequest.apiVersion) &&
        Objects.equals(this.description, v1ProjectRequest.description) &&
        Objects.equals(this.displayName, v1ProjectRequest.displayName) &&
        Objects.equals(this.kind, v1ProjectRequest.kind) &&
        Objects.equals(this.metadata, v1ProjectRequest.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ProjectRequest {\n");
