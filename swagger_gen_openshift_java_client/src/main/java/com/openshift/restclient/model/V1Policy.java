...
import com.openshift.restclient.model.V1NamedRole;
 ...
 */
@ApiModel(description = "Policy is a object that holds all the Roles for a particular namespace.  There is at most one Policy document per namespace.")
...
public class V1Policy   {
  ...
  private List<V1NamedRole> roles = new ArrayList<V1NamedRole>();

  public V1Policy apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Policy kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1Policy lastModified(String lastModified) {
   ...
   * @return lastModified
  **/
  @ApiModelProperty(example = "null", required = true, value = "LastModified is the last time that any part of the Policy was created, updated, or deleted")
  ...
  public V1Policy metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Policy roles(List<V1NamedRole> roles) {
    this.roles = roles;
    return this;
  }

  public V1Policy addRolesItem(V1NamedRole rolesItem) {
   ...
   * @return roles
  **/
  @ApiModelProperty(example = "null", required = true, value = "Roles holds all the Roles held by this Policy, mapped by Role.Name")
  public List<V1NamedRole> getRoles() {
    return roles;
  }

  public void setRoles(List<V1NamedRole> roles) {
    this.roles = roles;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.apiVersion, v1Policy.apiVersion) &&
        Objects.equals(this.kind, v1Policy.kind) &&
        Objects.equals(this.lastModified, v1Policy.lastModified) &&
        Objects.equals(this.metadata, v1Policy.metadata) &&
        Objects.equals(this.roles, v1Policy.roles);
  }
