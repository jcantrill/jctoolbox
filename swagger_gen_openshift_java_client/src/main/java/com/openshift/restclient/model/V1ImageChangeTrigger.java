...
public class V1ImageChangeTrigger   {
  @SerializedName("from")
  ...
  public V1ImageChangeTrigger from(V1ObjectReference from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public V1ImageChangeTrigger lastTriggeredImageID(String lastTriggeredImageID) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "lastTriggeredImageID is used internally by the ImageChangeController to save last used image ID for build")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ImageChangeTrigger v1ImageChangeTrigger = (V1ImageChangeTrigger) o;
    return Objects.equals(this.from, v1ImageChangeTrigger.from) &&
        Objects.equals(this.lastTriggeredImageID, v1ImageChangeTrigger.lastTriggeredImageID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(from, lastTriggeredImageID);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ImageChangeTrigger {\n");
