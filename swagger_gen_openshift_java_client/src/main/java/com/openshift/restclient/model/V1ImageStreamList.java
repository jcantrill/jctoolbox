 ...
 */
@ApiModel(description = "ImageStreamList is a list of ImageStream objects.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ImageStreamList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1ImageStream> items = new ArrayList<V1ImageStream>();
  ...
  public V1ImageStreamList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ImageStreamList items(List<V1ImageStream> items) {
    this.items = items;
    return this;
  }

  public V1ImageStreamList addItemsItem(V1ImageStream itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of imageStreams")
  public List<V1ImageStream> getItems() {
    return items;
  }

  public void setItems(List<V1ImageStream> items) {
    this.items = items;
  }

  public V1ImageStreamList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStreamList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ImageStreamList v1ImageStreamList = (V1ImageStreamList) o;
    return Objects.equals(this.apiVersion, v1ImageStreamList.apiVersion) &&
        Objects.equals(this.items, v1ImageStreamList.items) &&
        Objects.equals(this.kind, v1ImageStreamList.kind) &&
        Objects.equals(this.metadata, v1ImageStreamList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ImageStreamList {\n");
