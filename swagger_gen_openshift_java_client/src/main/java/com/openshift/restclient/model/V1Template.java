...
import com.openshift.restclient.model.RuntimeRawExtension;
import com.openshift.restclient.model.V1ObjectMeta;
import com.openshift.restclient.model.V1Parameter;
...
public class V1Template   {
  ...
  private List<RuntimeRawExtension> objects = new ArrayList<RuntimeRawExtension>();

  @SerializedName("parameters")
  private List<V1Parameter> parameters = new ArrayList<V1Parameter>();
  ...
  **/
  ...
  public V1Template labels(Object labels) {
    this.labels = labels;
    return this;
  }
   ...
   * @return labels
  **/
  @ApiModelProperty(example = "null", value = "labels is a optional set of labels that are applied to every object during the Template to Config transformation.")
  ...
  public V1Template message(String message) {
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "message is an optional instructional message that will be displayed when this template is instantiated. This field should inform the user how to utilize the newly created resources. Parameter substitution will be performed on the message before being displayed so that generated credentials and other parameters can be included in the output.")
  ...
  **/
  ...
  public V1Template objects(List<RuntimeRawExtension> objects) {
    this.objects = objects;
    return this;
  }

  public V1Template addObjectsItem(RuntimeRawExtension objectsItem) {
   ...
   * @return objects
  **/
  @ApiModelProperty(example = "null", required = true, value = "objects is an array of resources to include in this template.")
  public List<RuntimeRawExtension> getObjects() {
    return objects;
  }

  public void setObjects(List<RuntimeRawExtension> objects) {
    this.objects = objects;
  }

  public V1Template parameters(List<V1Parameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public V1Template addParametersItem(V1Parameter parametersItem) {
   ...
   * @return parameters
  **/
  @ApiModelProperty(example = "null", value = "parameters is an optional array of Parameters used during the Template to Config transformation.")
  public List<V1Parameter> getParameters() {
    return parameters;
  }

  public void setParameters(List<V1Parameter> parameters) {
    this.parameters = parameters;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.apiVersion, v1Template.apiVersion) &&
        Objects.equals(this.kind, v1Template.kind) &&
        Objects.equals(this.labels, v1Template.labels) &&
        Objects.equals(this.message, v1Template.message) &&
        Objects.equals(this.metadata, v1Template.metadata) &&
        Objects.equals(this.objects, v1Template.objects) &&
        Objects.equals(this.parameters, v1Template.parameters);
  }
