...
public class V1ClusterRoleBindingList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of ClusterRoleBindings")
  ...
  **/
  ...
  public V1ClusterRoleBindingList metadata(UnversionedListMeta metadata) {
