...
public class V1LimitRangeList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of LimitRange objects. More info: http://releases.k8s.io/release-1.4/docs/design/admission_control_limit_range.md")
  ...
  **/
  ...
  public V1LimitRangeList metadata(UnversionedListMeta metadata) {
