...
public class V1HostPathVolumeSource   {
   ...
   * @return path
  **/
  @ApiModelProperty(example = "null", required = true, value = "Path of the directory on the host. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#hostpath")
