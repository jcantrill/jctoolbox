...
public class V1EventSource   {
   ...
   * @return component
  **/
  @ApiModelProperty(example = "null", value = "Component from which the event is generated.")
   ...
   * @return host
  **/
  @ApiModelProperty(example = "null", value = "Host name on which the event is generated.")
