...
public class V1ServiceAccountList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of ServiceAccounts. More info: http://releases.k8s.io/release-1.4/docs/design/service_accounts.md#service-accounts")
  ...
  **/
  ...
  public V1ServiceAccountList metadata(UnversionedListMeta metadata) {
