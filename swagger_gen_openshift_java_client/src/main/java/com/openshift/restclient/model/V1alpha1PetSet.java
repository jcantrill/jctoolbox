...
import com.openshift.restclient.model.V1alpha1PetSetSpec;
import com.openshift.restclient.model.V1alpha1PetSetStatus;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;


/**
 * PetSet represents a set of pods with consistent identities. Identities are defined as:  - Network: A single stable DNS and hostname.  - Storage: As many VolumeClaims as requested. The PetSet guarantees that a given network identity will always map to the same storage identity. PetSet is currently in alpha and subject to change without notice.
 */
@ApiModel(description = "PetSet represents a set of pods with consistent identities. Identities are defined as:  - Network: A single stable DNS and hostname.  - Storage: As many VolumeClaims as requested. The PetSet guarantees that a given network identity will always map to the same storage identity. PetSet is currently in alpha and subject to change without notice.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1alpha1PetSet   {
  ...
  @SerializedName("spec")
  private V1alpha1PetSetSpec spec = null;

  @SerializedName("status")
  private V1alpha1PetSetStatus status = null;

  public V1alpha1PetSet apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1alpha1PetSet kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1alpha1PetSet metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1alpha1PetSet spec(V1alpha1PetSetSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1alpha1PetSetSpec getSpec() {
    return spec;
  }

  public void setSpec(V1alpha1PetSetSpec spec) {
    this.spec = spec;
  }

  public V1alpha1PetSet status(V1alpha1PetSetStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1alpha1PetSetStatus getStatus() {
    return status;
  }

  public void setStatus(V1alpha1PetSetStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1PetSet v1alpha1PetSet = (V1alpha1PetSet) o;
    return Objects.equals(this.apiVersion, v1alpha1PetSet.apiVersion) &&
        Objects.equals(this.kind, v1alpha1PetSet.kind) &&
        Objects.equals(this.metadata, v1alpha1PetSet.metadata) &&
        Objects.equals(this.spec, v1alpha1PetSet.spec) &&
        Objects.equals(this.status, v1alpha1PetSet.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PetSet {\n");
