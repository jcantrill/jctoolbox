...
public class V1PersistentVolumeList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of persistent volumes. More info: http://releases.k8s.io/release-1.4/docs/user-guide/persistent-volumes.md")
  ...
  **/
  ...
  public V1PersistentVolumeList metadata(UnversionedListMeta metadata) {
