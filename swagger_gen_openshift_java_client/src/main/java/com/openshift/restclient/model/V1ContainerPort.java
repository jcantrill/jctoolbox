...
public class V1ContainerPort   {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Number of port to expose on the pod's IP address. This must be a valid port number, 0 < x < 65536.")
   ...
   * @return hostIP
  **/
  @ApiModelProperty(example = "null", value = "What host IP to bind the external port to.")
   ...
   * @return hostPort
  **/
  @ApiModelProperty(example = "null", value = "Number of port to expose on the host. If specified, this must be a valid port number, 0 < x < 65536. If HostNetwork is specified, this must match ContainerPort. Most containers do not need this.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "If specified, this must be an IANA_SVC_NAME and unique within the pod. Each named port in a pod must have a unique name. Name for the port that can be referred to by services.")
   ...
   * @return protocol
  **/
  @ApiModelProperty(example = "null", value = "Protocol for port. Must be UDP or TCP. Defaults to \"TCP\".")
