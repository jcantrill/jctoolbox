 ...
 */
@ApiModel(description = "TemplateList is a list of Template objects.")
...
public class V1TemplateList   {
  ...
  private List<V1Template> items = new ArrayList<V1Template>();
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of templates")
  ...
  **/
  ...
  public V1TemplateList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1TemplateList v1TemplateList = (V1TemplateList) o;
    return Objects.equals(this.apiVersion, v1TemplateList.apiVersion) &&
        Objects.equals(this.items, v1TemplateList.items) &&
        Objects.equals(this.kind, v1TemplateList.kind) &&
        Objects.equals(this.metadata, v1TemplateList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1TemplateList {\n");
