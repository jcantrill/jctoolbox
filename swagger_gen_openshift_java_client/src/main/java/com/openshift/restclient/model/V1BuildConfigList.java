 ...
 */
@ApiModel(description = "BuildConfigList is a collection of BuildConfigs.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1BuildConfigList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1BuildConfig> items = new ArrayList<V1BuildConfig>();
  ...
  public V1BuildConfigList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1BuildConfigList items(List<V1BuildConfig> items) {
    this.items = items;
    return this;
  }

  public V1BuildConfigList addItemsItem(V1BuildConfig itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "items is a list of build configs")
  public List<V1BuildConfig> getItems() {
    return items;
  }

  public void setItems(List<V1BuildConfig> items) {
    this.items = items;
  }

  public V1BuildConfigList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1BuildConfigList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1BuildConfigList v1BuildConfigList = (V1BuildConfigList) o;
    return Objects.equals(this.apiVersion, v1BuildConfigList.apiVersion) &&
        Objects.equals(this.items, v1BuildConfigList.items) &&
        Objects.equals(this.kind, v1BuildConfigList.kind) &&
        Objects.equals(this.metadata, v1BuildConfigList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1BuildConfigList {\n");
