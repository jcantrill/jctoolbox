...
public class V1OAuthClientList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1OAuthClient> items = new ArrayList<V1OAuthClient>();
  ...
  public V1OAuthClientList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthClientList items(List<V1OAuthClient> items) {
    this.items = items;
    return this;
  }

  public V1OAuthClientList addItemsItem(V1OAuthClient itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of OAuth clients")
  public List<V1OAuthClient> getItems() {
    return items;
  }

  public void setItems(List<V1OAuthClient> items) {
    this.items = items;
  }

  public V1OAuthClientList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthClientList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthClientList v1OAuthClientList = (V1OAuthClientList) o;
    return Objects.equals(this.apiVersion, v1OAuthClientList.apiVersion) &&
        Objects.equals(this.items, v1OAuthClientList.items) &&
        Objects.equals(this.kind, v1OAuthClientList.kind) &&
        Objects.equals(this.metadata, v1OAuthClientList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1OAuthClientList {\n");
