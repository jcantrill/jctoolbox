...
public class V1beta1RunAsUserStrategyOptions   {
   ...
   * @return ranges
  **/
  @ApiModelProperty(example = "null", value = "Ranges are the allowed ranges of uids that may be used.")
   ...
   * @return rule
  **/
  @ApiModelProperty(example = "null", required = true, value = "Rule is the strategy that will dictate the allowable RunAsUser values that may be set.")
