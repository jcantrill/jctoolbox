 ...
 */
@ApiModel(description = "ClusterNetwork describes the cluster network. There is normally only one object of this type, named \"default\", which is created by the SDN network plugin based on the master configuration when the cluster is brought up for the first time.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ClusterNetwork   {
  ...
  public V1ClusterNetwork apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ClusterNetwork hostsubnetlength(Integer hostsubnetlength) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "HostSubnetLength is the number of bits of network to allocate to each node. eg, 8 would mean that each node would have a /24 slice of the overlay network for its pods")
  ...
  public V1ClusterNetwork kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterNetwork metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1ClusterNetwork network(String network) {
   ...
   * @return network
  **/
  @ApiModelProperty(example = "null", required = true, value = "Network is a CIDR string specifying the global overlay network's L3 space")
  ...
  public V1ClusterNetwork pluginName(String pluginName) {
   ...
   * @return pluginName
  **/
  @ApiModelProperty(example = "null", value = "PluginName is the name of the network plugin being used")
  ...
  public V1ClusterNetwork serviceNetwork(String serviceNetwork) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "ServiceNetwork is the CIDR range that Service IP addresses are allocated from")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterNetwork v1ClusterNetwork = (V1ClusterNetwork) o;
    return Objects.equals(this.apiVersion, v1ClusterNetwork.apiVersion) &&
        Objects.equals(this.hostsubnetlength, v1ClusterNetwork.hostsubnetlength) &&
        Objects.equals(this.kind, v1ClusterNetwork.kind) &&
        Objects.equals(this.metadata, v1ClusterNetwork.metadata) &&
        Objects.equals(this.network, v1ClusterNetwork.network) &&
        Objects.equals(this.pluginName, v1ClusterNetwork.pluginName) &&
        Objects.equals(this.serviceNetwork, v1ClusterNetwork.serviceNetwork);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, hostsubnetlength, kind, metadata, network, pluginName, serviceNetwork);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1ClusterNetwork {\n");
