 ...
 */
@ApiModel(description = "ThirdPartyResourceList is a list of ThirdPartyResources.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1beta1ThirdPartyResourceList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1beta1ThirdPartyResource> items = new ArrayList<V1beta1ThirdPartyResource>();
  ...
  public V1beta1ThirdPartyResourceList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1beta1ThirdPartyResourceList items(List<V1beta1ThirdPartyResource> items) {
    this.items = items;
    return this;
  }

  public V1beta1ThirdPartyResourceList addItemsItem(V1beta1ThirdPartyResource itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of ThirdPartyResources.")
  public List<V1beta1ThirdPartyResource> getItems() {
    return items;
  }

  public void setItems(List<V1beta1ThirdPartyResource> items) {
    this.items = items;
  }

  public V1beta1ThirdPartyResourceList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1beta1ThirdPartyResourceList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1ThirdPartyResourceList v1beta1ThirdPartyResourceList = (V1beta1ThirdPartyResourceList) o;
    return Objects.equals(this.apiVersion, v1beta1ThirdPartyResourceList.apiVersion) &&
        Objects.equals(this.items, v1beta1ThirdPartyResourceList.items) &&
        Objects.equals(this.kind, v1beta1ThirdPartyResourceList.kind) &&
        Objects.equals(this.metadata, v1beta1ThirdPartyResourceList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1ThirdPartyResourceList {\n");
