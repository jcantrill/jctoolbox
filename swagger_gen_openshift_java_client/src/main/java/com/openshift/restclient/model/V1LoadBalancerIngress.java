...
public class V1LoadBalancerIngress   {
   ...
   * @return hostname
  **/
  @ApiModelProperty(example = "null", value = "Hostname is set for load-balancer ingress points that are DNS based (typically AWS load-balancers)")
   ...
   * @return ip
  **/
  @ApiModelProperty(example = "null", value = "IP is set for load-balancer ingress points that are IP based (typically GCE or OpenStack load-balancers)")
  public String getIp() {
    return ip;
  }
