 ...
 */
@ApiModel(description = "ImageStreamTagList is a list of ImageStreamTag objects.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ImageStreamTagList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1ImageStreamTag> items = new ArrayList<V1ImageStreamTag>();
  ...
  public V1ImageStreamTagList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ImageStreamTagList items(List<V1ImageStreamTag> items) {
    this.items = items;
    return this;
  }

  public V1ImageStreamTagList addItemsItem(V1ImageStreamTag itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of image stream tags")
  public List<V1ImageStreamTag> getItems() {
    return items;
  }

  public void setItems(List<V1ImageStreamTag> items) {
    this.items = items;
  }

  public V1ImageStreamTagList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStreamTagList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ImageStreamTagList v1ImageStreamTagList = (V1ImageStreamTagList) o;
    return Objects.equals(this.apiVersion, v1ImageStreamTagList.apiVersion) &&
        Objects.equals(this.items, v1ImageStreamTagList.items) &&
        Objects.equals(this.kind, v1ImageStreamTagList.kind) &&
        Objects.equals(this.metadata, v1ImageStreamTagList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ImageStreamTagList {\n");
