...
import com.openshift.restclient.model.V1ImageStreamSpec;
import com.openshift.restclient.model.V1ImageStreamStatus;
 ...
 */
@ApiModel(description = "ImageStream stores a mapping of tags to images, metadata overrides that are applied when images are tagged in a stream, and an optional reference to a Docker image repository on a registry.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ImageStream   {
  ...
  @SerializedName("spec")
  private V1ImageStreamSpec spec = null;

  @SerializedName("status")
  private V1ImageStreamStatus status = null;

  public V1ImageStream apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ImageStream kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStream metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1ImageStream spec(V1ImageStreamSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStreamSpec getSpec() {
    return spec;
  }

  public void setSpec(V1ImageStreamSpec spec) {
    this.spec = spec;
  }

  public V1ImageStream status(V1ImageStreamStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1ImageStreamStatus getStatus() {
    return status;
  }

  public void setStatus(V1ImageStreamStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ImageStream v1ImageStream = (V1ImageStream) o;
    return Objects.equals(this.apiVersion, v1ImageStream.apiVersion) &&
        Objects.equals(this.kind, v1ImageStream.kind) &&
        Objects.equals(this.metadata, v1ImageStream.metadata) &&
        Objects.equals(this.spec, v1ImageStream.spec) &&
        Objects.equals(this.status, v1ImageStream.status);
  }
