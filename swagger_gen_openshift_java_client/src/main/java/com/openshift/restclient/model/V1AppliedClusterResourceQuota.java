...
import com.openshift.restclient.model.V1ClusterResourceQuotaSpec;
import com.openshift.restclient.model.V1ClusterResourceQuotaStatus;
 ...
 */
@ApiModel(description = "AppliedClusterResourceQuota mirrors ClusterResourceQuota at a project scope, for projection into a project.  It allows a project-admin to know which ClusterResourceQuotas are applied to his project and their associated usage.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1AppliedClusterResourceQuota   {
  ...
  @SerializedName("spec")
  private V1ClusterResourceQuotaSpec spec = null;

  @SerializedName("status")
  private V1ClusterResourceQuotaStatus status = null;

  public V1AppliedClusterResourceQuota apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1AppliedClusterResourceQuota kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1AppliedClusterResourceQuota metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1AppliedClusterResourceQuota spec(V1ClusterResourceQuotaSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "")
  public V1ClusterResourceQuotaSpec getSpec() {
    return spec;
  }

  public void setSpec(V1ClusterResourceQuotaSpec spec) {
    this.spec = spec;
  }

  public V1AppliedClusterResourceQuota status(V1ClusterResourceQuotaStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterResourceQuotaStatus getStatus() {
    return status;
  }

  public void setStatus(V1ClusterResourceQuotaStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1AppliedClusterResourceQuota v1AppliedClusterResourceQuota = (V1AppliedClusterResourceQuota) o;
    return Objects.equals(this.apiVersion, v1AppliedClusterResourceQuota.apiVersion) &&
        Objects.equals(this.kind, v1AppliedClusterResourceQuota.kind) &&
        Objects.equals(this.metadata, v1AppliedClusterResourceQuota.metadata) &&
        Objects.equals(this.spec, v1AppliedClusterResourceQuota.spec) &&
        Objects.equals(this.status, v1AppliedClusterResourceQuota.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1AppliedClusterResourceQuota {\n");
