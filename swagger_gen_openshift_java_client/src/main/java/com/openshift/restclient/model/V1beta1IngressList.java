...
public class V1beta1IngressList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1beta1Ingress> items = new ArrayList<V1beta1Ingress>();
  ...
  **/
  ...
  public V1beta1IngressList items(List<V1beta1Ingress> items) {
    this.items = items;
    return this;
  }

  public V1beta1IngressList addItemsItem(V1beta1Ingress itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of Ingress.")
  public List<V1beta1Ingress> getItems() {
    return items;
  }

  public void setItems(List<V1beta1Ingress> items) {
    this.items = items;
  }

  public V1beta1IngressList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1beta1IngressList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1beta1IngressList v1beta1IngressList = (V1beta1IngressList) o;
    return Objects.equals(this.apiVersion, v1beta1IngressList.apiVersion) &&
        Objects.equals(this.items, v1beta1IngressList.items) &&
        Objects.equals(this.kind, v1beta1IngressList.kind) &&
        Objects.equals(this.metadata, v1beta1IngressList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1beta1IngressList {\n");
