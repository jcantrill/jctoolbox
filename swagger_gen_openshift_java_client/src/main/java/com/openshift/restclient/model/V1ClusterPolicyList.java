 ...
 */
@ApiModel(description = "ClusterPolicyList is a collection of ClusterPolicies")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ClusterPolicyList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1ClusterPolicy> items = new ArrayList<V1ClusterPolicy>();
  ...
  public V1ClusterPolicyList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ClusterPolicyList items(List<V1ClusterPolicy> items) {
    this.items = items;
    return this;
  }

  public V1ClusterPolicyList addItemsItem(V1ClusterPolicy itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of ClusterPolicies")
  public List<V1ClusterPolicy> getItems() {
    return items;
  }

  public void setItems(List<V1ClusterPolicy> items) {
    this.items = items;
  }

  public V1ClusterPolicyList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterPolicyList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterPolicyList v1ClusterPolicyList = (V1ClusterPolicyList) o;
    return Objects.equals(this.apiVersion, v1ClusterPolicyList.apiVersion) &&
        Objects.equals(this.items, v1ClusterPolicyList.items) &&
        Objects.equals(this.kind, v1ClusterPolicyList.kind) &&
        Objects.equals(this.metadata, v1ClusterPolicyList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ClusterPolicyList {\n");
