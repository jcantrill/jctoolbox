...
public class V1alpha1PodDisruptionBudgetSpec   {
  ...
  public V1alpha1PodDisruptionBudgetSpec minAvailable(String minAvailable) {
   ...
   * @return minAvailable
  **/
  @ApiModelProperty(example = "null", value = "The minimum number of pods that must be available simultaneously.  This can be either an integer or a string specifying a percentage, e.g. \"28%\".")
  ...
  public V1alpha1PodDisruptionBudgetSpec selector(UnversionedLabelSelector selector) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1PodDisruptionBudgetSpec v1alpha1PodDisruptionBudgetSpec = (V1alpha1PodDisruptionBudgetSpec) o;
    return Objects.equals(this.minAvailable, v1alpha1PodDisruptionBudgetSpec.minAvailable) &&
        Objects.equals(this.selector, v1alpha1PodDisruptionBudgetSpec.selector);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1PodDisruptionBudgetSpec {\n");
