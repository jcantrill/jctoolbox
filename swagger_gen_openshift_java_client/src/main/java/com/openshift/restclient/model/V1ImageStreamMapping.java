 ...
 */
@ApiModel(description = "ImageStreamMapping represents a mapping from a single tag to a Docker image as well as the reference to the Docker image stream the image came from.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ImageStreamMapping   {
  ...
  public V1ImageStreamMapping apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ImageStreamMapping image(V1Image image) {
    this.image = image;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStreamMapping kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ImageStreamMapping metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1ImageStreamMapping tag(String tag) {
    this.tag = tag;
    return this;
  }
   ...
   * @return tag
  **/
  @ApiModelProperty(example = "null", required = true, value = "Tag is a string value this image can be located with inside the stream.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ImageStreamMapping v1ImageStreamMapping = (V1ImageStreamMapping) o;
    return Objects.equals(this.apiVersion, v1ImageStreamMapping.apiVersion) &&
        Objects.equals(this.image, v1ImageStreamMapping.image) &&
        Objects.equals(this.kind, v1ImageStreamMapping.kind) &&
        Objects.equals(this.metadata, v1ImageStreamMapping.metadata) &&
        Objects.equals(this.tag, v1ImageStreamMapping.tag);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ImageStreamMapping {\n");
