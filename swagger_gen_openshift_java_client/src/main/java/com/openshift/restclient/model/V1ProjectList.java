...
public class V1ProjectList   {
  ...
  public V1ProjectList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ProjectList items(List<V1Project> items) {
    this.items = items;
    return this;
  }

  public V1ProjectList addItemsItem(V1Project itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of projects")
  ...
  public V1ProjectList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ProjectList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ProjectList v1ProjectList = (V1ProjectList) o;
    return Objects.equals(this.apiVersion, v1ProjectList.apiVersion) &&
        Objects.equals(this.items, v1ProjectList.items) &&
        Objects.equals(this.kind, v1ProjectList.kind) &&
        Objects.equals(this.metadata, v1ProjectList.metadata);
  }
