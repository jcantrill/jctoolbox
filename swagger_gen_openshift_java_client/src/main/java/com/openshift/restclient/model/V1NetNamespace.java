 ...
 */
@ApiModel(description = "NetNamespace describes a single isolated network. When using the redhat/openshift-ovs-multitenant plugin, every Namespace will have a corresponding NetNamespace object with the same name. (When using redhat/openshift-ovs-subnet, NetNamespaces are not used.)")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1NetNamespace   {
  ...
  public V1NetNamespace apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1NetNamespace kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1NetNamespace metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1NetNamespace netid(Integer netid) {
    this.netid = netid;
    return this;
  }
   ...
   * @return netid
  **/
  @ApiModelProperty(example = "null", required = true, value = "NetID is the network identifier of the network namespace assigned to each overlay network packet. This can be manipulated with the \"oadm pod-network\" commands.")
  ...
  public V1NetNamespace netname(String netname) {
   ...
   * @return netname
  **/
  @ApiModelProperty(example = "null", required = true, value = "NetName is the name of the network namespace. (This is the same as the object's name, but both fields must be set.)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1NetNamespace v1NetNamespace = (V1NetNamespace) o;
    return Objects.equals(this.apiVersion, v1NetNamespace.apiVersion) &&
        Objects.equals(this.kind, v1NetNamespace.kind) &&
        Objects.equals(this.metadata, v1NetNamespace.metadata) &&
        Objects.equals(this.netid, v1NetNamespace.netid) &&
        Objects.equals(this.netname, v1NetNamespace.netname);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, kind, metadata, netid, netname);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1NetNamespace {\n");
