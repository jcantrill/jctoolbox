 ...
 */
@ApiModel(description = "ClusterPolicyBindingList is a collection of ClusterPolicyBindings")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1ClusterPolicyBindingList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1ClusterPolicyBinding> items = new ArrayList<V1ClusterPolicyBinding>();
  ...
  public V1ClusterPolicyBindingList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1ClusterPolicyBindingList items(List<V1ClusterPolicyBinding> items) {
    this.items = items;
    return this;
  }

  public V1ClusterPolicyBindingList addItemsItem(V1ClusterPolicyBinding itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of ClusterPolicyBindings")
  public List<V1ClusterPolicyBinding> getItems() {
    return items;
  }

  public void setItems(List<V1ClusterPolicyBinding> items) {
    this.items = items;
  }

  public V1ClusterPolicyBindingList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1ClusterPolicyBindingList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterPolicyBindingList v1ClusterPolicyBindingList = (V1ClusterPolicyBindingList) o;
    return Objects.equals(this.apiVersion, v1ClusterPolicyBindingList.apiVersion) &&
        Objects.equals(this.items, v1ClusterPolicyBindingList.items) &&
        Objects.equals(this.kind, v1ClusterPolicyBindingList.kind) &&
        Objects.equals(this.metadata, v1ClusterPolicyBindingList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ClusterPolicyBindingList {\n");
