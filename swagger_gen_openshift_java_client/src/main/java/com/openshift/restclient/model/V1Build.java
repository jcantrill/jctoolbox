...
import com.openshift.restclient.model.V1BuildSpec;
import com.openshift.restclient.model.V1BuildStatus;
...
public class V1Build   {
  ...
  @SerializedName("spec")
  private V1BuildSpec spec = null;

  @SerializedName("status")
  private V1BuildStatus status = null;

  public V1Build apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Build kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1Build metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Build spec(V1BuildSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1BuildSpec getSpec() {
    return spec;
  }

  public void setSpec(V1BuildSpec spec) {
    this.spec = spec;
  }

  public V1Build status(V1BuildStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V1BuildStatus getStatus() {
    return status;
  }

  public void setStatus(V1BuildStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.apiVersion, v1Build.apiVersion) &&
        Objects.equals(this.kind, v1Build.kind) &&
        Objects.equals(this.metadata, v1Build.metadata) &&
        Objects.equals(this.spec, v1Build.spec) &&
        Objects.equals(this.status, v1Build.status);
  }
