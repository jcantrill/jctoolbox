...
public class V1SELinuxOptions   {
   ...
   * @return level
  **/
  @ApiModelProperty(example = "null", value = "Level is SELinux level label that applies to the container.")
   ...
   * @return role
  **/
  @ApiModelProperty(example = "null", value = "Role is a SELinux role label that applies to the container.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "Type is a SELinux type label that applies to the container.")
   ...
   * @return user
  **/
  @ApiModelProperty(example = "null", value = "User is a SELinux user label that applies to the container.")
