 ...
 */
@ApiModel(description = "OAuthClientAuthorizationList is a collection of OAuth client authorizations")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1OAuthClientAuthorizationList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1OAuthClientAuthorization> items = new ArrayList<V1OAuthClientAuthorization>();
  ...
  public V1OAuthClientAuthorizationList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthClientAuthorizationList items(List<V1OAuthClientAuthorization> items) {
    this.items = items;
    return this;
  }

  public V1OAuthClientAuthorizationList addItemsItem(V1OAuthClientAuthorization itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of OAuth client authorizations")
  public List<V1OAuthClientAuthorization> getItems() {
    return items;
  }

  public void setItems(List<V1OAuthClientAuthorization> items) {
    this.items = items;
  }

  public V1OAuthClientAuthorizationList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthClientAuthorizationList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthClientAuthorizationList v1OAuthClientAuthorizationList = (V1OAuthClientAuthorizationList) o;
    return Objects.equals(this.apiVersion, v1OAuthClientAuthorizationList.apiVersion) &&
        Objects.equals(this.items, v1OAuthClientAuthorizationList.items) &&
        Objects.equals(this.kind, v1OAuthClientAuthorizationList.kind) &&
        Objects.equals(this.metadata, v1OAuthClientAuthorizationList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1OAuthClientAuthorizationList {\n");
