 ...
 */
@ApiModel(description = "EgressNetworkPolicyList is a collection of EgressNetworkPolicy")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1EgressNetworkPolicyList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1EgressNetworkPolicy> items = new ArrayList<V1EgressNetworkPolicy>();
  ...
  public V1EgressNetworkPolicyList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1EgressNetworkPolicyList items(List<V1EgressNetworkPolicy> items) {
    this.items = items;
    return this;
  }

  public V1EgressNetworkPolicyList addItemsItem(V1EgressNetworkPolicy itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "items is the list of policies")
  public List<V1EgressNetworkPolicy> getItems() {
    return items;
  }

  public void setItems(List<V1EgressNetworkPolicy> items) {
    this.items = items;
  }

  public V1EgressNetworkPolicyList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1EgressNetworkPolicyList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1EgressNetworkPolicyList v1EgressNetworkPolicyList = (V1EgressNetworkPolicyList) o;
    return Objects.equals(this.apiVersion, v1EgressNetworkPolicyList.apiVersion) &&
        Objects.equals(this.items, v1EgressNetworkPolicyList.items) &&
        Objects.equals(this.kind, v1EgressNetworkPolicyList.kind) &&
        Objects.equals(this.metadata, v1EgressNetworkPolicyList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1EgressNetworkPolicyList {\n");
