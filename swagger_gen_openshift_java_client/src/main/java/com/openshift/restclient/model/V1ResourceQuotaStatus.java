...
public class V1ResourceQuotaStatus   {
  ...
  public V1ResourceQuotaStatus hard(Object hard) {
    this.hard = hard;
    return this;
  }
   ...
   * @return hard
  **/
  @ApiModelProperty(example = "null", value = "Hard is the set of enforced hard limits for each named resource. More info: http://releases.k8s.io/release-1.4/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota")
  ...
  public V1ResourceQuotaStatus used(Object used) {
    this.used = used;
    return this;
  }
