...
public class V1ClusterResourceQuotaSelector   {
  @SerializedName("annotations")
  private Object annotations = null;

  @SerializedName("labels")
  private UnversionedLabelSelector labels = null;

  public V1ClusterResourceQuotaSelector annotations(Object annotations) {
   ...
   * @return annotations
  **/
  @ApiModelProperty(example = "null", required = true, value = "AnnotationSelector is used to select projects by annotation.")
  ...
  public V1ClusterResourceQuotaSelector labels(UnversionedLabelSelector labels) {
    this.labels = labels;
    return this;
  }
  ...
  **/
  ...
  public UnversionedLabelSelector getLabels() {
    return labels;
  }

  public void setLabels(UnversionedLabelSelector labels) {
    this.labels = labels;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ClusterResourceQuotaSelector v1ClusterResourceQuotaSelector = (V1ClusterResourceQuotaSelector) o;
    return Objects.equals(this.annotations, v1ClusterResourceQuotaSelector.annotations) &&
        Objects.equals(this.labels, v1ClusterResourceQuotaSelector.labels);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ClusterResourceQuotaSelector {\n");
