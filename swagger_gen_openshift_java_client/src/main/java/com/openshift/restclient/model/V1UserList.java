...
public class V1UserList   {
  ...
  public V1UserList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1UserList items(List<V1User> items) {
    this.items = items;
    return this;
  }

  public V1UserList addItemsItem(V1User itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of users")
  ...
  public V1UserList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1UserList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1UserList v1UserList = (V1UserList) o;
    return Objects.equals(this.apiVersion, v1UserList.apiVersion) &&
        Objects.equals(this.items, v1UserList.items) &&
        Objects.equals(this.kind, v1UserList.kind) &&
        Objects.equals(this.metadata, v1UserList.metadata);
  }
