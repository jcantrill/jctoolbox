...
public class V1NamespaceList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of Namespace objects in the list. More info: http://releases.k8s.io/release-1.4/docs/user-guide/namespaces.md")
  ...
  **/
  ...
  public V1NamespaceList metadata(UnversionedListMeta metadata) {
