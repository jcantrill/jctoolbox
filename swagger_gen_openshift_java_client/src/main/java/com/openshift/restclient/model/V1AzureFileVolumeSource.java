...
public class V1AzureFileVolumeSource   {
  ...
  **/
   ...
   * @return secretName
  **/
  @ApiModelProperty(example = "null", required = true, value = "the name of secret that contains Azure Storage Account Name and Key")
   ...
   * @return shareName
  **/
  @ApiModelProperty(example = "null", required = true, value = "Share Name")
