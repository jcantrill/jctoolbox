...
public class V1SecretList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of secret objects. More info: http://releases.k8s.io/release-1.4/docs/user-guide/secrets.md")
  ...
  **/
  ...
  public V1SecretList metadata(UnversionedListMeta metadata) {
