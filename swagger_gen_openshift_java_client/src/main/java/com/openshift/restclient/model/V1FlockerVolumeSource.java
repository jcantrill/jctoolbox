 ...
 */
@ApiModel(description = "Represents a Flocker volume mounted by the Flocker agent. Flocker volumes do not support ownership management or SELinux relabeling.")
...
public class V1FlockerVolumeSource   {
   ...
   * @return datasetName
  **/
  @ApiModelProperty(example = "null", required = true, value = "Required: the volume name. This is going to be store on metadata -> name on the payload for Flocker")
