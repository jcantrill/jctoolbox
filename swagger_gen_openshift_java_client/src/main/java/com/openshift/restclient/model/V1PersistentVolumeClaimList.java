...
public class V1PersistentVolumeClaimList   {
  ...
  **/
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "A list of persistent volume claims. More info: http://releases.k8s.io/release-1.4/docs/user-guide/persistent-volumes.md#persistentvolumeclaims")
  ...
  **/
  ...
  public V1PersistentVolumeClaimList metadata(UnversionedListMeta metadata) {
