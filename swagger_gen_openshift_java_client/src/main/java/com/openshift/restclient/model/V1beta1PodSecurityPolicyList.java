 ...
 */
@ApiModel(description = "Pod Security Policy List is a list of PodSecurityPolicy objects.")
...
public class V1beta1PodSecurityPolicyList   {
  ...
  **/
  ...
  public V1beta1PodSecurityPolicyList metadata(UnversionedListMeta metadata) {
