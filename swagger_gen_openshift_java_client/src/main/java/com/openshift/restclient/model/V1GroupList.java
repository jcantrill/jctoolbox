...
public class V1GroupList   {
  ...
  public V1GroupList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1GroupList items(List<V1Group> items) {
    this.items = items;
    return this;
  }

  public V1GroupList addItemsItem(V1Group itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of groups")
  public List<V1Group> getItems() {
    return items;
  }

  public void setItems(List<V1Group> items) {
    this.items = items;
  }

  public V1GroupList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1GroupList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1GroupList v1GroupList = (V1GroupList) o;
    return Objects.equals(this.apiVersion, v1GroupList.apiVersion) &&
        Objects.equals(this.items, v1GroupList.items) &&
        Objects.equals(this.kind, v1GroupList.kind) &&
        Objects.equals(this.metadata, v1GroupList.metadata);
  }
