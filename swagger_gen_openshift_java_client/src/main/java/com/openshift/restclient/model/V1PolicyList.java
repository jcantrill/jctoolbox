...
public class V1PolicyList   {
  ...
  public V1PolicyList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1PolicyList items(List<V1Policy> items) {
    this.items = items;
    return this;
  }

  public V1PolicyList addItemsItem(V1Policy itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of Policies")
  public List<V1Policy> getItems() {
    return items;
  }

  public void setItems(List<V1Policy> items) {
    this.items = items;
  }

  public V1PolicyList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1PolicyList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PolicyList v1PolicyList = (V1PolicyList) o;
    return Objects.equals(this.apiVersion, v1PolicyList.apiVersion) &&
        Objects.equals(this.items, v1PolicyList.items) &&
        Objects.equals(this.kind, v1PolicyList.kind) &&
        Objects.equals(this.metadata, v1PolicyList.metadata);
  }
