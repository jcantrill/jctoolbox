...
public class V1NodeCondition   {
  ...
  public V1NodeCondition lastHeartbeatTime(String lastHeartbeatTime) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Last time we got an update on a given condition.")
  ...
  public V1NodeCondition lastTransitionTime(String lastTransitionTime) {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type of node condition.")
