...
public class V1ServiceAccount   {
  ...
  private List<V1ObjectReference> secrets = new ArrayList<V1ObjectReference>();
  ...
  **/
  @ApiModelProperty(example = "null", value = "ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount. ImagePullSecrets are distinct from Secrets because Secrets can be mounted in the pod, but ImagePullSecrets are only accessed by the kubelet. More info: http://releases.k8s.io/release-1.4/docs/user-guide/secrets.md#manually-specifying-an-imagepullsecret")
  ...
  **/
   ...
   * @return secrets
  **/
  @ApiModelProperty(example = "null", value = "Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: http://releases.k8s.io/release-1.4/docs/user-guide/secrets.md")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, imagePullSecrets, kind, metadata, secrets);
  }
