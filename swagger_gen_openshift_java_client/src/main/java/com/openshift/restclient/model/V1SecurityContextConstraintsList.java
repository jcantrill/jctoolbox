 ...
 */
@ApiModel(description = "SecurityContextConstraintsList is a list of SecurityContextConstraints objects")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1SecurityContextConstraintsList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1SecurityContextConstraints> items = new ArrayList<V1SecurityContextConstraints>();
  ...
  public V1SecurityContextConstraintsList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1SecurityContextConstraintsList items(List<V1SecurityContextConstraints> items) {
    this.items = items;
    return this;
  }

  public V1SecurityContextConstraintsList addItemsItem(V1SecurityContextConstraints itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of security context constraints.")
  public List<V1SecurityContextConstraints> getItems() {
    return items;
  }

  public void setItems(List<V1SecurityContextConstraints> items) {
    this.items = items;
  }

  public V1SecurityContextConstraintsList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1SecurityContextConstraintsList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1SecurityContextConstraintsList v1SecurityContextConstraintsList = (V1SecurityContextConstraintsList) o;
    return Objects.equals(this.apiVersion, v1SecurityContextConstraintsList.apiVersion) &&
        Objects.equals(this.items, v1SecurityContextConstraintsList.items) &&
        Objects.equals(this.kind, v1SecurityContextConstraintsList.kind) &&
        Objects.equals(this.metadata, v1SecurityContextConstraintsList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1SecurityContextConstraintsList {\n");
