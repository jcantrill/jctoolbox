 ...
 */
@ApiModel(description = "NetNamespaceList is a collection of NetNamespaces")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1NetNamespaceList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1NetNamespace> items = new ArrayList<V1NetNamespace>();
  ...
  public V1NetNamespaceList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1NetNamespaceList items(List<V1NetNamespace> items) {
    this.items = items;
    return this;
  }

  public V1NetNamespaceList addItemsItem(V1NetNamespace itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is the list of net namespaces")
  public List<V1NetNamespace> getItems() {
    return items;
  }

  public void setItems(List<V1NetNamespace> items) {
    this.items = items;
  }

  public V1NetNamespaceList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1NetNamespaceList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1NetNamespaceList v1NetNamespaceList = (V1NetNamespaceList) o;
    return Objects.equals(this.apiVersion, v1NetNamespaceList.apiVersion) &&
        Objects.equals(this.items, v1NetNamespaceList.items) &&
        Objects.equals(this.kind, v1NetNamespaceList.kind) &&
        Objects.equals(this.metadata, v1NetNamespaceList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1NetNamespaceList {\n");
