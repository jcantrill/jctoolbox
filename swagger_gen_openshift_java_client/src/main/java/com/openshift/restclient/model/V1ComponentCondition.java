...
public class V1ComponentCondition   {
   ...
   * @return error
  **/
  @ApiModelProperty(example = "null", value = "Condition error code for a component. For example, a health check error code.")
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "Message about the condition for a component. For example, information about a health check.")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", required = true, value = "Status of the condition for a component. Valid values for \"Healthy\": \"True\", \"False\", or \"Unknown\".")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type of condition for a component. Valid value: \"Healthy\"")
