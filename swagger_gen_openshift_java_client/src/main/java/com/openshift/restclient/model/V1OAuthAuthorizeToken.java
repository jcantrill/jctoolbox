...
public class V1OAuthAuthorizeToken   {
  ...
  public V1OAuthAuthorizeToken apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken clientName(String clientName) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken codeChallenge(String codeChallenge) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "CodeChallenge is the optional code_challenge associated with this authorization code, as described in rfc7636")
  ...
  public V1OAuthAuthorizeToken codeChallengeMethod(String codeChallengeMethod) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "CodeChallengeMethod is the optional code_challenge_method associated with this authorization code, as described in rfc7636")
  ...
  public V1OAuthAuthorizeToken expiresIn(Long expiresIn) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1OAuthAuthorizeToken metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken redirectURI(String redirectURI) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken scopes(List<String> scopes) {
    this.scopes = scopes;
    return this;
  }

  public V1OAuthAuthorizeToken addScopesItem(String scopesItem) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken state(String state) {
    this.state = state;
    return this;
  }
   ...
   * @return state
  **/
  @ApiModelProperty(example = "null", value = "State data from request")
  ...
  public V1OAuthAuthorizeToken userName(String userName) {
  ...
  **/
  ...
  public V1OAuthAuthorizeToken userUID(String userUID) {
   ...
   * @return userUID
  **/
  @ApiModelProperty(example = "null", value = "UserUID is the unique UID associated with this token. UserUID and UserName must both match for this token to be valid.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1OAuthAuthorizeToken v1OAuthAuthorizeToken = (V1OAuthAuthorizeToken) o;
    return Objects.equals(this.apiVersion, v1OAuthAuthorizeToken.apiVersion) &&
        Objects.equals(this.clientName, v1OAuthAuthorizeToken.clientName) &&
        Objects.equals(this.codeChallenge, v1OAuthAuthorizeToken.codeChallenge) &&
        Objects.equals(this.codeChallengeMethod, v1OAuthAuthorizeToken.codeChallengeMethod) &&
        Objects.equals(this.expiresIn, v1OAuthAuthorizeToken.expiresIn) &&
        Objects.equals(this.kind, v1OAuthAuthorizeToken.kind) &&
        Objects.equals(this.metadata, v1OAuthAuthorizeToken.metadata) &&
        Objects.equals(this.redirectURI, v1OAuthAuthorizeToken.redirectURI) &&
        Objects.equals(this.scopes, v1OAuthAuthorizeToken.scopes) &&
        Objects.equals(this.state, v1OAuthAuthorizeToken.state) &&
        Objects.equals(this.userName, v1OAuthAuthorizeToken.userName) &&
        Objects.equals(this.userUID, v1OAuthAuthorizeToken.userUID);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1OAuthAuthorizeToken {\n");
