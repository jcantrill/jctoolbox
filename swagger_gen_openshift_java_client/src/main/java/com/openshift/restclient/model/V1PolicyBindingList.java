 ...
 */
@ApiModel(description = "PolicyBindingList is a collection of PolicyBindings")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-10-24T16:19:28.908-04:00")
public class V1PolicyBindingList   {
  @SerializedName("apiVersion")
  private String apiVersion = null;

  @SerializedName("items")
  private List<V1PolicyBinding> items = new ArrayList<V1PolicyBinding>();
  ...
  public V1PolicyBindingList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1PolicyBindingList items(List<V1PolicyBinding> items) {
    this.items = items;
    return this;
  }

  public V1PolicyBindingList addItemsItem(V1PolicyBinding itemsItem) {
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Items is a list of PolicyBindings")
  public List<V1PolicyBinding> getItems() {
    return items;
  }

  public void setItems(List<V1PolicyBinding> items) {
    this.items = items;
  }

  public V1PolicyBindingList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V1PolicyBindingList metadata(UnversionedListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1PolicyBindingList v1PolicyBindingList = (V1PolicyBindingList) o;
    return Objects.equals(this.apiVersion, v1PolicyBindingList.apiVersion) &&
        Objects.equals(this.items, v1PolicyBindingList.items) &&
        Objects.equals(this.kind, v1PolicyBindingList.kind) &&
        Objects.equals(this.metadata, v1PolicyBindingList.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1PolicyBindingList {\n");
