...
import com.openshift.restclient.model.V2alpha1JobSpec;
import com.openshift.restclient.model.V2alpha1JobStatus;
...
public class V2alpha1Job   {
  ...
  @SerializedName("spec")
  private V2alpha1JobSpec spec = null;

  @SerializedName("status")
  private V2alpha1JobStatus status = null;

  public V2alpha1Job apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V2alpha1Job kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public V2alpha1Job metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V2alpha1Job spec(V2alpha1JobSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V2alpha1JobSpec getSpec() {
    return spec;
  }

  public void setSpec(V2alpha1JobSpec spec) {
    this.spec = spec;
  }

  public V2alpha1Job status(V2alpha1JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public V2alpha1JobStatus getStatus() {
    return status;
  }

  public void setStatus(V2alpha1JobStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2alpha1Job v2alpha1Job = (V2alpha1Job) o;
    return Objects.equals(this.apiVersion, v2alpha1Job.apiVersion) &&
        Objects.equals(this.kind, v2alpha1Job.kind) &&
        Objects.equals(this.metadata, v2alpha1Job.metadata) &&
        Objects.equals(this.spec, v2alpha1Job.spec) &&
        Objects.equals(this.status, v2alpha1Job.status);
  }
